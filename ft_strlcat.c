...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/04 23:24:37 by efmacm23          #+#    #+#             */
/*   Updated: 2025/08/04 23:24:40 by efmacm23         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	ft_strlcat(char *dest, const char *src, size_t total_len)
{
	...
	_iter_copy_src_to_dest(&dest[len_dest], src, total_len - len_dest);
...
// static bool	_iter_copy_src_to_dest(char *dest, const char *src, size_t start, size_t len)
// {
// 	if (!dest || !src || !len || start >= ft_strlen(dest))
// 		return (false);
// 	while (len > start + 1 && src[start] != '\0')
// 	{
